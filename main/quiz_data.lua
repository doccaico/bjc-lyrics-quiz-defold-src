...
M.bank = {
    ...
    },
    {
        ...
        lyrics = {
            "新しい僕の 左腕の傷は とても深くて",
            "美しいから 君に見せよう さあ早くここへきて",
            "そしておまえの愛を感じたい",
            "車しておまえの愛を感じたい",
            "太陽が傾いて この部屋がゆっくり",
            "あたたかなオレンジ色に染まってゆく その中で",
    ...
    },
    {
        ...
        lyrics = {
            "Bang! 指でピストル 口で発射音",
            "おまえの頭 今 吹き飛ばした",
            "もうおしまいだぜ 俺の愛するかわいいお前よ",
            "さよならさ",
            "Oh 悪ふざけさ",
            "オレの大好きなそんな悲しい目をするなよ",
            "ただ時々なぜか不吉な事がしてみたくなるオレは",
            "イカレテルかもしれない",
            "Oh 車の街に住むオレ達2人は",
            "水分のない乾いた水色だから",
            "Oh どこから見たっていかしてるぜ",
            "CoolなRockみたいにけがれ知らず",
            "Oh 行く着く所だけはきれいな丘の上に決めているから",
    ...
    },
    {
        ...
        lyrics = {
            ...
            "さみしさは手のひらにのせて 空にあげればいいから",
            "フリンジのロングコート マールボロくわえながら",
            "激しく腰を動かせ",
            "Baby 砂嵐がそこまでやってきてる",
            "早くゴーグルを着けなよ",
            "あまりに強い風が吹いたら 2人は",
    ...
    {
        title = "ヘッドライトのわくのとれかたがいかしてる車",
        lyrics = {
            "インディアンの羽根を着けて",
            "恋人がおどけながらしゃべる",
            "私はこの空からうれしく思われてるはず",
            "なぜなら転げ回る雪の中を笑顔を見せるから",
    ...
    },
    {
        ...
        lyrics = {
            ...
            "ビニールシーツを体に射ち込む……",
            "一体どんな気分なんだろう?",
            "口じゃ言えないほどの快感に陥るってことは",
            "噂じゃ聞いているけど オレのママが悲しむ",
            "君が誰だろうと 君が何歳だろうとかまわない",
            "きれいな顔してるとか",
            "コーヒー色の肌をしているだとか",
            "感動的な夜を ただ過ごしてみたいだけだから",
            "そう オレは愚かな人間 おまえと同じさ",
            "いつか指先に止まる 蝶の羽はきれいな青緑",
            "なんでも言うことをきくよ 猿のマネでも出来るさ",
            "オレのハートは多分 破れたビニールシーツ",
            "もう少し この胸をときめかせて",
            "そう オレは愚かな人間 おまえと同じ",
            "おまえと同じさ おまえと同じさ (x5)",
        },
    },
    {
        ...
        lyrics = {
            ...
            "俺のおんぼろ Made in American, Herlay",
            "Oh, Baby Baby バカデカいエンジン ふかせば",
            "俺の頭の中で ハツカネズミがダンスしだすんだよ",
            "白いセンターライン Hey You Can CRIMBTO Heven Now",
            "Yes, I'd Like I'm Ready Now",
            "Oh, Baby Baby ドロドロオイルまみれて",
            "夜明けまで ずっと過ごした事もあるんだ",
            "Oh, Baby Baby ギャブレターホース溶けるまで",
            "イカレた夜を 走り続けた事もあるんだ",
            "白いセンターライン Hey You Can CRIMBTO Heven Now",
            "Yes, I'd Like I'm Ready Now",
            "Shake Shake Shake Your Head",
            "Shake Dance Dance Dance Your Head Dance",
            "Shake Shake Shake Your Head",
            "Shake Dance Dance Dance Your Head",
            "Shake Shake Shake And Dance Your Head",
            "Oh, Baby Baby まるでスクラップみたいさ",
            "俺のおんぼろ Made in American, Herlay",
            "Oh, Baby Baby バカデカいエンジン ふかせば",
            "俺の頭の中で ハツカネズミがダンスしだすんだよ",
